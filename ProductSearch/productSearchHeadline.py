...
class ProductSearchHeadline(BaseAddOn):
    responses = [
        "./ProductSearch/response/headlineAds.json"
    ]
    ...
    def request_matcher(
        ...
        return "query($headline_params: String)" in req_meta_data.body_query
