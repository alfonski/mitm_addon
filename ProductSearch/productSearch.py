...
class ProductSearch(BaseAddOn):
    responses = [
        "./ProductSearch/response/productSearch.json",
        "./ProductSearch/response/productSearchEmpty.json"
    ]
    ...
    def request_matcher(
        ...
        return "query SearchProduct" in req_meta_data.body_query

    @property
    def modified_response_file(self) -> str: return self.responses[0]

    @property
    def error_response_file(self) -> str: return "./ProductSearch/response/productSearchError.json"
