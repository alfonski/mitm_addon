...
class ChatReplies(BaseAddOn):
    responses = [
        "./chat/response/chat_replies_review.json",
        "./chat/response/chat_replies_common.json",
        "./chat/response/chat_replies_test.json"
    ]
    ...
    def request_matcher(
        ...
        return "query chatReplies" in req_meta_data.body_query
