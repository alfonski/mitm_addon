...
class ChatBlastMetadata(BaseAddOn):
    responses = [
        "./chat/response/chat_blast_metadata.json"    
    ]
    ...
    def request_matcher(
        ...
        return "query chatBlastSellerMetadata" in req_meta_data.body_query
