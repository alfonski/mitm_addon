...
class ChatOrderProgress(BaseAddOn):
    responses = [
        "./chat/response/order_progress_state_on_going.json"
    ]
    ...
    def request_matcher(
        ...
        return "query chatOrderProgress" in req_meta_data.body_query
