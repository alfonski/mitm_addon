...
class ChatListGroupSticker(BaseAddOn):
    responses = [
        "./chat/response/chat_list_group_sticker.json"
    ]
    ...
    def request_matcher(
        ...
        return "query chatListGroupSticker" in req_meta_data.body_query
