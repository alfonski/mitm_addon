...
class ChatHistoryProduct(BaseAddOn):
    responses = [
        "./chat/response/order_progress_history_product.json"
    ]
    ...
    def request_matcher(
        ...
        return "query chatHistoryProducts" in req_meta_data.body_query
