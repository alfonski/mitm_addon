...
class ChatDetailSmartReply(BaseAddOn):
    responses = [
        "./chat/response/chat_detail_smart_reply.json"
    ]
    ...
    def request_matcher(
        ...
        return "query chatSmartReplyQuestion" in req_meta_data.body_query
