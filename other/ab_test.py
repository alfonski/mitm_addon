...
class AbTestRollOutFeatureVariant(BaseAddOn):
    responses = [
        "./other/response/ab_test.json"
    ]
    ...
    def create_add_on_config(self) -> AddOnConfig:
        return AddOnConfig(
            name="AbTestRollOutFeatureVariant",
    ...
    def request_matcher(
        ...
        return "query RolloutFeatureVariants" in req_meta_data.body_query
    ...
    def request_attribute_changer(self, request_meta_data: RequestMetaData, request: Request):
        # request_meta_data.body_params["id"] = "18873513"
