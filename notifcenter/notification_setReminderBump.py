...
class NotificationSetReminderBump(BaseAddOn):
    responses = [
        "./notifcenter/response/notification_set_reminder_bump.json"
    ]
    ...
    def create_add_on_config(self) -> AddOnConfig:
        return AddOnConfig(
            name="NotificationSetReminderBump",
    ...
    def request_matcher(
        ...
        return "mutation notifcenter_setReminderBump" in req_meta_data.body_query
