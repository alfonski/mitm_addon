...
class NotificationDeleteReminderBump(BaseAddOn):
    responses = [
        "./notifcenter/response/notification_delete_reminder_bump.json"
    ]
    ...
    def create_add_on_config(self) -> AddOnConfig:
        return AddOnConfig(
            name="NotificationDeleteReminderBump mutation notifcenter_deleteReminderBump",
    ...
    def request_matcher(
        ...
        return "mutation notifcenter_deleteReminderBump" in req_meta_data.body_query
...
addons = [
    NotificationDeleteReminderBump()
]
