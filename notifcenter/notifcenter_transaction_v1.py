...
class NotifCenterTransaction(BaseAddOn):
    responses = [
        "./notifcenter/response/notifcenter_detail_v1.json",
    ]
    ...
    def create_add_on_config(self) -> AddOnConfig:
        return AddOnConfig(
            name="old notifcenter transaction query notifcenter_detail_v1",
    ...
    def request_matcher(
        ...
        return "query get_notification_update" in req_meta_data.body_query
