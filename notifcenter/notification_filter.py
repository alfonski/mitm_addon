...
class NotificationFilterV2(BaseAddOn):
    responses = [
        "./notifcenter/response/notification_filter.json"
    ]
    ...
    def request_matcher(
        ...
        return "query notifcenter_filter_v2" in req_meta_data.body_query
