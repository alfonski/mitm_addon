...
class NotificationUoh(BaseAddOn):
    responses = [
        "./notifcenter/response/notifcenter_uoh.json",
    ]
    ...
    def create_add_on_config(self) -> AddOnConfig:
        return AddOnConfig(
            name="NotificationCenter query notifcenter_notifOrderList",
    ...
    def request_matcher(
        ...
        return "query notifcenter_notifOrderList" in req_meta_data.body_query
